/**
 * "My Issues" screen (pushed from the More popover). Three scopes —
 * assigned / created / agents — mirroring web's
 * `packages/views/my-issues/components/my-issues-page.tsx:48-65`. The
...
export default function MyIssues() {
  ...
  const headerRight = useCallback(
    ...
    // openFilter only reads wsSlug — stable enough to bind once per mount.
  ...
  return (
    <View className="flex-1 bg-background">
      <Stack.Screen
        options={{ title: "My Issues", headerBackTitle: "Back", headerRight }}
      />
      <ScopeToolbar
        scopes={SCOPES}
        scope={scope}
